...
<html>
	...
	<body>
		<div id = "mt-container">
			...
			<div id = "mt-welcome">
				<?php
					$results = DB::select("SELECT * FROM interactions,media WHERE user_id = ? AND interactions.category = 'downloaded' AND authorid = user_id AND media_id = id ORDER BY created_on desc limit ?,6", array($userid, ($page - 1) * 6));
